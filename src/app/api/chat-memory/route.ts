...
export async function POST(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.error('⚠️ DynamoDB save failed, but returning success anyway:', dbError);
      
      // Even if DynamoDB save fails, return success
      // The message was received and processed, storage is secondary
      return NextResponse.json({
        success: true,
