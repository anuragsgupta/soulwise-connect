    ...
    <div className="fixed inset-0 bg-black/80 z-50 flex items-center justify-center p-3 sm:p-4 md:p-6 overflow-y-auto">
      <Card className="w-full max-w-lg lg:max-w-2xl my-auto bg-background border-2 border-primary/20">
        <div className="p-4 sm:p-6 md:p-8">
          ...
          {/* Settings Panel */}
          {showSettings && (
            <Card className="p-3 sm:p-4 mb-4 sm:mb-6 bg-primary/5 border border-primary/10">
              <label className="text-xs sm:text-sm font-medium mb-3 block font-heading">
          ...
          {/* Box Visualization */}
          <div className="relative w-full aspect-square max-w-[280px] sm:max-w-sm md:max-w-md mx-auto mb-6 sm:mb-8">
            {/* The Box */}
            <svg className="w-full h-full" viewBox="0 0 200 200">
              ...
              <text
                ...
                y="95"
                textAnchor="middle"
                className="text-2xl sm:text-3xl font-bold fill-primary font-heading"
              >
                {isPlaying ? count : '●'}
              </text>
              <text
                ...
                y="115"
                textAnchor="middle"
                className="text-xs sm:text-sm fill-muted-foreground font-accent"
              >
