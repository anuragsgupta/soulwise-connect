...
const DATABASE_URL = process.env.DATABASE_URL || 'postgresql://postgres.mqnibarfktnjncodliba:7pnsqtgZmpdZexF3@aws-1-ap-south-1.pooler.supabase.com:6543/postgres?pgbouncer=true&connection_limit=1';
